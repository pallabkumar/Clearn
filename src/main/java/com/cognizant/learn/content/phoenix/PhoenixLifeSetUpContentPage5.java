...
public class PhoenixLifeSetUpContentPage5 extends JPanel {
		...
		public PhoenixLifeSetUpContentPage5(int width, int height) {
			...
			JLabel contentLabel1 = new JLabel(" Update the ear and war version number in target.properties file as below. ");
			...
			JLabel imageLabel = new JLabel(GuiUtility.getImageIcon("/phoenix_life_setup/phoenix-img-05.png"));
