...
public class PhoenixLifeSetUpContentPage3 extends JPanel {
		...
		public PhoenixLifeSetUpContentPage3(int width, int height) {
			...
			JLabel contentLabel1 = new JLabel(" Note down the POM version number(here -> 1.0.1.0). ");
			...
			JLabel imageLabel = new JLabel(GuiUtility.getImageIcon("/phoenix_life_setup/phoenix-img-03.png"));
