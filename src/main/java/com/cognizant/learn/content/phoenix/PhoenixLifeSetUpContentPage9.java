...
public class PhoenixLifeSetUpContentPage9 extends JPanel {
		...
		public PhoenixLifeSetUpContentPage9(int width, int height) {
...
//			headerPanel.setBorder(BorderFactory.createLineBorder(Color.red));
			...
			JLabel headerLabel = new JLabel(ContentMenuWiseContentPanelMapper.PHOENIX_LIFE_SUB_MENU_3);
			...
			JLabel contentLabel1 = new JLabel(" Then start Weblogic-12C server using startWebLogic.cmd. ");
			...
			JLabel imageLabel = new JLabel(GuiUtility.getImageIcon("/phoenix_life_setup/phoenix-img-09.png"));
