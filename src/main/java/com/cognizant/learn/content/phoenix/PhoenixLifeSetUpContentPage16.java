...
public class PhoenixLifeSetUpContentPage16 extends JPanel {
		...
		public PhoenixLifeSetUpContentPage16(int width, int height) {
...
//			headerPanel.setBorder(BorderFactory.createLineBorder(Color.red));
			...
			JLabel headerLabel = new JLabel(ContentMenuWiseContentPanelMapper.PHOENIX_LIFE_SUB_MENU_5);
			...
			JLabel contentLabel1 = new JLabel(" Now login to ->  http://localhost:7001/lifeportal/. ");
			...
			JLabel imageLabel = new JLabel(GuiUtility.getImageIcon("/phoenix_life_setup/phoenix-img-16.png"));
