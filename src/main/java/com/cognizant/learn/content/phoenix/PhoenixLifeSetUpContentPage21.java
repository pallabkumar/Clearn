...
public class PhoenixLifeSetUpContentPage21 extends JPanel {
		...
		public PhoenixLifeSetUpContentPage21(int width, int height) {
			
			JPanel imagePanel = new JPanel();
			imagePanel.setLayout(new FlowLayout(FlowLayout.CENTER));
			JLabel imageLabel = new JLabel(GuiUtility.getImageIcon("/phoenix_life_setup/phoenix-img-20.png"));
