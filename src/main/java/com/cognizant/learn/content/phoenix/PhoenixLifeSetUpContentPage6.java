...
public class PhoenixLifeSetUpContentPage6 extends JPanel {
		...
		public PhoenixLifeSetUpContentPage6(int width, int height) {
			...
			JLabel contentLabel1 = new JLabel(" Do the Ant build for your project. ");
			...
			JLabel imageLabel = new JLabel(GuiUtility.getImageIcon("/phoenix_life_setup/phoenix-img-06.png"));
