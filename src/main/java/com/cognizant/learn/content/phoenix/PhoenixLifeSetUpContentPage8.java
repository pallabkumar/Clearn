...
public class PhoenixLifeSetUpContentPage8 extends JPanel {
		...
		public PhoenixLifeSetUpContentPage8(int width, int height) {
			...
			JTextArea contentLabel1 = new JTextArea(" Follow the same steps 1 to 6 for axaefair, axalife. The ear and war files will be created in corresponding local_artifacts folder. ");
			
			contentLabel1.setEditable(false);
			contentLabel1.setBackground(ViewDetails.CLEARN_CONTENT_COLOR);
			contentLabel1.setPreferredSize(new Dimension(width - 75, 50));
			contentLabel1.setMaximumSize(new Dimension(width - 75, 50));
			contentLabel1.setMinimumSize(new Dimension(width - 75, 50));
			contentLabel1.setLineWrap(true);
